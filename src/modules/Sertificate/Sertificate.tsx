        ...
        <div className={styles.content}>
          <div className={styles.contentLeft}>
            <p className={styles.descr}>
              ...
              Вы можете зайти к нам в гости в студию и приобрести сертификат в
              бумажном виде, либо оформить его в электронном виде online.
            </p>
            <a
              target="_blank"
          ...
          <div className={styles.imgContainer}>
            <Image
              ...
              fill
              src={"/assets/sertificate/sertificate.jpg"}
              alt="автопортрет"
            />
          </div>
        </div>
