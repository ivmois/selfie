...
const Header = () => {
  ...
  return (
    <header className={styles.header} ref={headerRef}>
      <a href="#hero" ref={logoRef} className={styles.logo} style={{ transform: `translate3d(0px, 0px, 0px) scale(${scale})` }}>
        <svg className={styles.svg} id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 508.25 164.3">
