			...
			<Container>
				...
				<div className={styles.content}>
					<p className={styles.descr}>
						...
						запомнится. А классные фотографии будут приятным напоминанием об этом дне. <br /> <br />
						Вы можете зайти к нам в гости в студию и приобрести сертификат или заказать его доставку. А также у нас есть
						online сертификаты.
					</p>
					<div className={styles.imgContainer}>
						<Image className={styles.img} fill src={sertificateImg} alt='автопортрет' />
					</div>
				</div>
			</Container>
		</section>
